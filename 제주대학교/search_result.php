  ...
  <!--검색 결과 테이블-->
    <table class="write">
      ...
      <?php
        ...
        $sql2 = "SELECT * FROM post WHERE $catagory LIKE '%$search_con%' ORDER BY post_id DESC";/*$search_con(검색 내용)이 들어간 모든 튜플을 내림차순으로 select*/
      ...
      <!--검색 결과 테이블-->
        <tbody>
          <tr>
            ...
            <td width="500">
          <a href='pw_input.php?id=<?php echo $post["post_id"]; ?>'><span><?php echo $title;?></span></a></td>
