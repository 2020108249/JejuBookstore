...
<html>
    <head>
        <title>제주서점</title>
        <meta charset="UTF-8">
        <link rel="stylesheet" href="../제주대학교/design.css" type="text/css">
    </head>
    <body>
        <p style="float:right">관리자(한라대학교) 님</p>
        <br><br>
        <div id="logo">
            <h1 id="main_logo" position:relative><a href="../제주대학교/home.html">제주서점(HNU)</a></h1>
            <div id="serch">
                <input type="seasrch" style="width:40%; height: 40px; font-size: 20px">
    ...
    <?php
      ...
      $bno = $_GET['stock_id'];
      $sql = "SELECT * FROM hstock where stock_id='$bno';";
