  ...
  <hr>
    ...
    <table class="write">
      <?php
        ...
        $sql2 = "SELECT * FROM hstock WHERE book_title LIKE '%$search_con%' ORDER BY stock_id DESC";
      ...
      <div>
        <!-- 처음화면으로 이동-->
      <h3 style="float: right;margin: 30px 200px 0 0;"><a href="home_hnu.php">[목록으로]</a></h3>
    </div>
  </div>
</body>
</html>
